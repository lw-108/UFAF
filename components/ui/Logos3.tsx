...
const Logos3 = ({
  ...
  return (
    <section className="py-10 mb-10 overflow-hidden">
      <div className="container flex flex-col items-center text-center">
        <h1 className="mb-10 -mt-20 text-2xl font-bold text-pretty lg:text-4xl">
          {heading}
        </h1>
      </div>
      <div>
        <div className="relative flex items-center justify-center mx-auto lg:max-w-5xl">
          <Carousel
            opts={{ loop: true }}
          ...
          >
            <CarouselContent className="ml-0">
              {logos.map((logo) => (
                <CarouselItem
                  key={logo.id}
                  className="flex justify-center pl-0 basis-1/3 sm:basis-1/4 md:basis-1/5 lg:basis-1/6"
                >
