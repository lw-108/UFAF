...
import { Star, Quote, ChevronLeft, ChevronRight, Play, User, Award, GraduationCap, Target, Users, Filter } from "lucide-react";
...
const testimonials = [
  {
    ...
    location: "Odisha",
    content: "U Fill Academy transformed my life. As a tribal student with limited resources, I never imagined I could compete for engineering entrance exams. The free coaching and personalized guidance helped me secure admission in IIT Bombay!",
    rating: 5,
  ...
  },
  {
    ...
    role: "Parent",
    location: "Jharkhand",
    content: "My daughter struggled with English for years. After joining U Fill Academy's language program, her confidence skyrocketed. She's now the first in our family to attend college. We are forever grateful.",
    rating: 5,
  ...
  },
  {
    ...
    location: "Mumbai",
    content: "Teaching here has been the most rewarding experience of my career. Seeing these brilliant minds overcome socioeconomic barriers through education is truly inspiring. U Fill Academy is creating real change.",
    rating: 5,
  ...
  },
  {
    ...
    location: "Gujarat",
    content: "The digital marketing course changed my life. Coming from a poor background, I now run my own small business and employ 3 other people from my community. Education truly is empowerment.",
    rating: 4,
  ...
  },
  {
    id: 5,
    name: "Sunita Devi",
    role: "Women's Education Program",
    location: "Rajasthan",
    content: "At 35, I learned to read and write for the first time. Now I help other women in my village. U Fill Academy gave me dignity and purpose. Education has no age limit.",
    rating: 5,
  ...
  },
  {
    ...
    content: "The free test series and doubt sessions were game-changers. Without access to expensive coaching, I scored 98.5%ile in JEE. Thank you for making quality education accessible!",
    rating: 5,
  ...
  },
  {
    ...
    location: "Assam",
    content: "The scholarship program covered my entire engineering fees. I'm now interning at a tech company and will be the first engineer in my family. This opportunity changed my family's future.",
    rating: 5,
  ...
  },
  {
    ...
    location: "Bangalore",
    content: "Partnering with U Fill Academy has been incredibly impactful. The talent we've recruited from their programs is exceptional. It's proof that with opportunity, anyone can excel.",
    rating: 4,
...
const categories = [
  ...
  { id: "parents", label: "Parents", icon: User, count: testimonials.filter(t => t.category === "parents").length },
  { id: "graduates", label: "Graduates", icon: Award, count: testimonials.filter(t => t.category === "graduates").length },
  { id: "women", label: "Women Empowerment", icon: Users, count: testimonials.filter(t => t.category === "women").length },
  { id: "volunteers", label: "Volunteers", icon: Target, count: testimonials.filter(t => t.category === "volunteers").length },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container px-4 py-16 mx-auto mt-20 text-center">
        ...
        <p className="max-w-3xl mx-auto mb-10 text-xl text-muted-foreground">
          Real experiences from students, parents, and volunteers whose lives have been transformed through education.
        </p>
      ...
      <div className="container px-4 pb-20 mx-auto">
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="relative">
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-primary/70"></div>
        ...
        <div className="mb-20">
          <h3 className="mb-8 text-3xl font-bold text-center text-foreground">Notable Achievements</h3>
          <div className="grid gap-6 md:grid-cols-2">
            {successStories.map((story) => (
              <div 
                key={story.id} 
                className="p-6 transition-all duration-300 border rounded-2xl bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 border-primary/20 group hover:shadow-lg"
              >
                <div className="flex items-start justify-between">
                  <div>
                    <h4 className="mb-2 text-lg font-semibold text-foreground">{story.name}</h4>
                ...
                <div className="px-4 py-2 rounded-lg bg-primary/20">
                  <span className="font-semibold text-primary">Achievement:</span> {story.achievement}
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-primary via-primary/90 to-primary/80">
            ...
            <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="heart-pattern" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
                  <path d="M50,20 C60,10 80,15 85,30 C90,45 70,60 50,80 C30,60 10,45 15,30 C20,15 40,10 50,20 Z" 
                        fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="1" />
                </pattern>
                <pattern id="star-pattern" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
                  <path d="M30,0 L36,20 L56,20 L40,32 L46,52 L30,40 L14,52 L20,32 L4,20 L24,20 Z" 
                        fill="none" stroke="rgba(255,255,255,0.1)" strokeWidth="1" />
                </pattern>
              </defs>
              <rect width="100%" height="100%" fill="url(#heart-pattern)" />
              <rect width="100%" height="100%" fill="url(#star-pattern)" opacity="0.5" />
          ...
          <div className="relative px-8 py-12 text-center">
            <h3 className="mb-4 text-3xl font-bold text-white">Share Your Story</h3>
            <p className="max-w-2xl mx-auto mb-8 text-white/90">
              Has U Fill Academy impacted your life? Share your journey and inspire others to pursue their dreams.
            </p>
        ...
        {/* Statistics */}
        <div className="mt-20">
          <h3 className="mb-8 text-3xl font-bold text-center text-foreground">Impact by Numbers</h3>
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
            <div className="p-6 text-center border rounded-2xl bg-card border-border">
              <div className="text-3xl font-bold text-primary">95%</div>
              <div className="text-sm text-muted-foreground">Students Continue Education</div>
            </div>
            <div className="p-6 text-center border rounded-2xl bg-card border-border">
              <div className="text-3xl font-bold text-primary">80%</div>
              <div className="text-sm text-muted-foreground">First Generation Learners</div>
            </div>
            <div className="p-6 text-center border rounded-2xl bg-card border-border">
