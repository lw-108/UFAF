...
import { Target, Eye, Users, Heart, ChevronRight, Globe, Award } from "lucide-react";
...
export default function MissionVision() {
  return (
    <section className="w-full px-4 py-20 border-b border-dashed rounded-4xl border-border">
      ...
      {/* Header */}
      <div className="max-w-4xl mx-auto space-y-4 text-center mt-25">
        <h2 className="font-serif text-4xl leading-tight tracking-tight text-transparent md:text-5xl lg:text-6xl md:leading-tight bg-linear-to-r from-primary to-primary/70 bg-clip-text">
          Mission & Vision
        </h2>
          ...
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="mission-pattern" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
                ...
                <path d="M0,0 L100,100 M100,0 L0,100" stroke="white" strokeWidth="0.5" opacity="0.2" />
              </pattern>
            </defs>
      ...
      <div className="grid max-w-6xl gap-8 mx-auto mt-20 lg:grid-cols-2">
        ...
        <div className="p-8 transition-all duration-300 border rounded-3xl bg-card border-border group hover:shadow-2xl">
          <div className="inline-flex p-4 mb-6 transition-transform duration-300 rounded-2xl bg-primary/20 group-hover:scale-110">
            <Target className="w-8 h-8 text-primary" />
          </div>
          <h3 className="mb-4 font-serif text-3xl font-bold text-foreground">Our Mission</h3>
        ...
        <div className="p-8 transition-all duration-300 border rounded-3xl bg-card border-border group hover:shadow-2xl">
          ...
          <h3 className="mb-4 font-serif text-3xl font-bold text-foreground">Our Vision</h3>
          <p className="mb-6 text-lg leading-relaxed text-muted-foreground">
          ...
          <div className="mt-8 space-y-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-foreground">Global Reach, Local Impact</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-lg bg-primary/10">
                <Target className="w-4 h-4 text-primary" />
              </div>
              <span className="text-foreground">Zero Barriers to Education</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-lg bg-primary/10">
                <Heart className="w-4 h-4 text-primary" />
              </div>
              <span className="text-foreground">Sustainable Transformation</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative max-w-6xl mx-auto mt-20 mb-10 overflow-hidden border rounded-3xl bg-linear-to-br from-primary via-primary/90 to-primary/80 border-border">
        ...
        <div className="absolute inset-0">
          <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="cta-geometric" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#cta-dots)" opacity="0.5" />
            
            {/* Floating Elements */}
            <circle cx="15%" cy="25%" r="25" fill="rgba(255,255,255,0.08)" />
            <circle cx="85%" cy="75%" r="30" fill="rgba(255,255,255,0.08)" />
            <rect x="70%" y="20%" width="40" height="40" fill="rgba(255,255,255,0.08)" transform="rotate(45)" />
          </svg>
        </div>
        ...
        <div className="relative px-8 py-12 md:px-12">
          <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
            <div className="text-white">
              <h3 className="mb-2 font-serif text-3xl font-bold">Join Our Educational Revolution</h3>
      ...
      <div className="max-w-6xl mx-auto mt-16">
        <h3 className="mb-8 font-serif text-3xl font-bold text-center text-foreground">Our Impact So Far</h3>
