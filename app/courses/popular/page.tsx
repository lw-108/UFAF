...
export default function PopularCoursesPage() {
  ...
  const topRated = [...coursesData].sort((a, b) => b.rating - a.rating).slice(0, 6)
  const mostEnrolled = [...coursesData].sort((a, b) => b.students - a.students).slice(0, 6)
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative mt-20 overflow-hidden bg-linear-to-b from-orange-500/5 to-background">
        ...
        <div className="container relative px-4 py-20 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 text-orange-500 rounded-full bg-orange-500/10">
            ...
            <div className="grid grid-cols-2 gap-6 mb-12 md:grid-cols-4">
              <div className="p-4 text-center">
                ...
                <div className="text-sm text-muted-foreground">Popular Courses</div>
              </div>
              <div className="p-4 text-center">
      ...
      <div className="container px-4 pb-20 mx-auto">
        {/* Timeframe Tabs */}
        <div className="mb-12">
          <Tabs defaultValue="all" className="w-full" onValueChange={(v: any) => setTimeframe(v)}>
            ...
            <TabsContent value="weekly" className="mt-0">
              <div className="py-12 text-center">
                <TrendingUp className="w-12 h-12 mx-auto mb-4 text-muted-foreground" />
                <h3 className="mb-2 text-xl font-semibold">Weekly trends coming soon</h3>
                <p className="text-muted-foreground">Check back for weekly trending courses</p>
              </div>
            </TabsContent>
          </Tabs>
        </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {trendingNow.map((item) => {
              ...
              return (
                <div key={item.id} className="p-6 transition-all border rounded-lg hover:border-primary/50">
          ...
          <section>
            ...
            <div className="space-y-4">
              {topRated.map((course, index) => (
                <div key={course.id} className="p-4 transition-colors border rounded-lg hover:border-primary/50">
                  <div className="flex items-center justify-between">
              ...
              {mostEnrolled.map((course, index) => (
                <div key={course.id} className="p-4 transition-colors border rounded-lg hover:border-primary/50">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        <div className="font-bold text-primary">{course.students}+</div>
